...
describe("action routes", () => {
    ...
    describe("GET /digipet/ignore", () => {
        test("if the user has a digipet, it responds with a message about ignoring it", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
...
describe("GET /digipet/rehome", () => {
    test("if the user has no digipet, it responds with a message explaining that a digipet can't be rehomeed whilst the user has none", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
    ...
    test("if the user has a digipet, it responds with a message about successfully rehomeing a digipet and calls rehomeDigipet", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup
        if (jest.isMockFunction(controller_1.rehomeDigipet) /* type guard */) {
            controller_1.rehomeDigipet.mockReset();
        }
